...
export const Alist = () => {
  return (
    <div className="w-fit mx-auto mt-6">
      <h2 className="font-semibold text-lg my-4 w-fit mx-auto">
        List your house for rent or sale here
      </h2>
      <form action="">
        <div className="flex ">
          <div>
          ...
          <div className="flex flex-col items-center w-fit mx-4">
            ...
            <span className="flex items-center ml-4">
              <input type="radio" value="Rent" name="listing-type" />
              Rent
            </span>
          </div>
          <div className="flex flex-col items-center w-fit mx-4">
            ...
            <span className="flex items-center ml-4">
              <input type="radio" value="Sale" name="listing-type" />
              Sale
            </span>
          </div>
        </div>
        ...
        <div className="pb-4">
          ...
          <div className="flex justify-between items-center">
            <span>
              <input type="radio" name="house-type" />
              Condominium
            </span>
            <span>
              <input type="radio" name="house-type" />
        ...
        <div className="flex justify-between mt-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between">
              <span>
                <input type="radio" name="funished" />
                Furnished
              </span>
              <span>
                <input type="radio" name="funished" />
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex justify-between mt-4">
            ...
            <div className="flex flex-col">
              <label htmlFor="">
                Add photos using the button or drag and drop in the box (Max 6
                photos allowed)
              </label>
        ...
        <div className="flex">
          <div className="flex items-center">
            <input type="radio" />
            <p className="w-1/3">
              bychecking this box i agree as follows: i am the owner of this
              properts or have the authority to transact on behalf of the owner.
              I will provide accurate and non discriminatory information, and i
              will comply with Terms and conditions of <em>COMPANY</em>.
            </p>
          </div>
